/**
 * @fileoverview Zod schemas for profile and password forms.
 * Layer: Validation — profile update and change-password validation.
 * Notes:
 * - Validation mirrors backend to keep UX and API behavior consistent.
 */
...
export const updateProfileSchema = z.object({
    ...
    // Updated normalized email field.
    email: z
...
// Validate newPassword and confirmPassword equality.
