/**
 * @fileoverview Ant Design theme configuration.
 * Layer: UI — premium dark tokens and component overrides.
 * Notes:
 * - Centralized token values keep visual language consistent.
 */
